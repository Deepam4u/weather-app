...
function SearchArea() {
    ...
    const getCityData = async (cityName) => {
        try {
            const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=metric&appid=${'2a51cfb0a58853b19e362a2606c46657'}`);
    ...
    return (
        <>
            <h1 className="mb-5 sm:text-6xl text-5xl font-bold text-white drop-shadow-xl">Weather App</h1>
